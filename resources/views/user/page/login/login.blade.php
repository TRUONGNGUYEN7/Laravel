...
<body style="background: #b0b5bbb2;">
     ...
     <div style=" margin-top: 200px ; margin-bottom: 400px" class="log-w3">
          <div style="background: rgba(35, 93, 183, 0.82);" class="w3layouts-main">
               ...
               <form action="{{ route('user.signin_action') }}" method="post" id="loginForm">
                    {{ csrf_field() }}
                    ...
                    <input style="background: rgba(35, 37, 183, 0.82);" type="submit" value="Sign In" name="login">
               </form>
               <p>Don't Have an Account ?<a href="{{ route('user.signup') }}">Create an account</a></p>
