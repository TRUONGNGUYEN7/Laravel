...
<script src="{{ asset('assetuser/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('assetuser/js/main.js') }}"></script>
<script src="{{ asset('assetuser/js/ads.js') }}"></script>
<script src="{{ asset('assetuser/js/popup.js') }}"></script>