                    ...
                    @foreach ($FourPosts->slice(1, 2) as $post)
                        <div class="card mb-3">
                            <div class="bg-img1 size-a-14 how1 pos-relative"
                                style="background-image: url({{ asset($fileUploadPath . $post->imageHash) }}); height: 150px">
                    ...
                    @if (isset($FourPosts[0]))
                        <div class="card mb-3">
                            <div class="bg-img1 size-a-3 how1 pos-relative"
                                style="background-image: url({{ asset($fileUploadPath. $FourPosts[0]->imageHash) }}); height: 366px">
                                <a href="{{ route("$moduleName/detail", ['id' => $FourPosts[0]->id]) }}"
                                    class="dis-block how1-child1 trans-03"></a>
                            </div>
                            <div class="card-body">
