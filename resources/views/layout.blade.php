...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('UserAssets/fonts/fontawesome-5.0.8/css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('UserAssets/fonts/iconic/css/material-design-iconic-font.min.css') }}">
                ...
                <div class="content-topbar container h-100">
                    <div class="left-topbar">
                        ...
                        @if (session('user_data'))
                            ...
                            <span class="left-topbar-item">Welcome, {{ session('user_data')['user_username'] }}</span>

                            <!-- Hiện mục đăng xuất -->
                            <a href="{{ route('user.logout') }}" class="left-topbar-item">
                                Log out
                            </a>
                        @else
                            ...
                            <a href="{{ route('user.signup') }}" class="left-topbar-item">
                                Sign up
                            </a>

                            <a href="{{ route('user.signin') }}" class="left-topbar-item">
                                Log in
                            </a>
                        @endif
