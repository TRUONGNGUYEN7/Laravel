               ...
               <div class="row w3-res-tb">
                    <div class="col-sm-3">
                         <div class="input-group">
                              <input placeholder="Tìm kiếm...." type="text" id="myInput"
                                   ...
                                   <tr style="">
                                        ...
                                        <td style="width: 5%;">
                                             <div style="width: 10px;">
                                                  ...
                                                  <a
                                                       href="{{ route('admin.danhmuc.status', ['id' => $item->IDDM, 'value' => 1]) }}">
                                                       <input type="checkbox" checked name="hienthi" class="switch-btn"
                                                            data-size="small" data-color="#0099ff">
                                                  </a>
                                                  @else

                                                  <a
                                                       href="{{ route('admin.danhmuc.status', ['id' => $item->IDDM, 'value' => 0]) }}">
                                                       <input type="checkbox" name="hienthi" class="switch-btn"
                                                            data-size="small" data-color="#0099ff">
                                                  </a>
                                                  @endif
                                             </div>
